    ...
    bool is_print_res)
{
    ...
    {
        cout << endl;
        cout << "Reading from dataset_dir: " << dataset_dit << endl;
...
vector<cv::Mat> readPoseFromFile(const string filename)
{
    ...
    vecotr<vector<double>> list_pose; // store, but not output
    ...
    // Read data
    constexpr int kNumValsPerRow = 12; // x, y, z, 1st column of R, 2nd coulumn of R, 3rd column of R
