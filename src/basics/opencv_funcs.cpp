...
cv::Mat convertRt2T(const cv::Mat &t)
{
...
// C++: double norm(InputArray src1, InputArrray src2, int normType=NORM_L2, InputArray mask=noArray())
{
    double sum = 0;
...
string getCvMatType(int cvMatType)
{
    ...
    */
    ...
    ucahr depth = cvMatType & CV_MAT_DEPTH_MASK;
