...
boost::shared_ptr<pcl::visualization::PCLVisualizer> // boost??
...
{
    setPointPos(point, p.at<double)(0, 0), p.at<doube>(1, 0), p.at<double>(2, 0);
}
...
void setPointPose(pcl::PointXYZ &point, cv::Mat p)
{
